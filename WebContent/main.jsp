...
<body class="easyui-layout" data-options="fit:true">
	<div class="easyui-layout" style="width: 100%; height: 100%;">
		...
		<div data-options="region:'south',border:false" style="height: 25px;">
			<center>©2019-2059 五邑大学&nbsp;&nbsp;&nbsp;计算机科学与技术2016</center>
		</div>
		<!--最右边部分-->
		...
		<div data-options="region:'west',iconCls:'icon-clipart',"
			...
			<div class="easyui-accordion">
				...
				<div title="公告管理" data-options="iconCls:'icon-ok'"
					style="overflow: auto; padding: 10px; height: 200px">
					<a href="#" class="easyui-linkbutton"
						data-options="plain:true,iconCls:'icon-print'" id="selectnotice">公告查询</a> <a
...
<script>
	...
	$(function() {//jq的页面加载完成事件
		...
		$("#selectemp").click(function() {
			addTab("#usertab", "员工查询", "icon-groupadd", "selectemp.jsp");
		});
		...
		$("#selectnotice").click(function() {
			addTab("#usertab", "公告查询", "icon-groupadd", "selectnotice.jsp");
		});
		...
		$("#upload").click(function(){
			addTab("#usertab", "文件上传", "icon-upload", "UploadServlet");	
